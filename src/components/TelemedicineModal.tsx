...
export default function TelemedicineModal({ 
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      id: 1,
      sender: userRole === 'patient' ? appointment.professionalName : appointment.patientName,
  ...
  const handleSendMessage = () => {
    if (newMessage.trim()) {
      setChatMessages(prev => [...prev, {
        id: Date.now(),
        sender: userRole === 'patient' ? appointment.patientName : appointment.professionalName,
        message: newMessage,
        timestamp: new Date().toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })
      }]);
      setNewMessage('');
          ...
          <DialogTitle className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm font-normal text-muted-foreground mt-1">
                {userRole === 'patient' ? `Dr(a). ${appointment.professionalName}` : appointment.patientName}
              </div>
            </div>
            ...
            <div className="w-full h-full flex items-center justify-center text-white" style={{
              ...
              {isConnected ? (
                ...
                <div className="text-center">
                  ...
                  <div className="text-xl font-medium mb-2">Aguardando conexão...</div>

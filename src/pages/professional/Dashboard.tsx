...
export default function ProfessionalDashboard() {
  ...
  const professionalRecords = medicalRecords.filter(
    (rec) => rec.professionalId === professional.id
  );
  ...
  const upcomingAppointments = professionalAppointments.filter(
    (apt) =>
      apt.status === "scheduled" &&
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Button size="sm">Atender Paciente</Button>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <div>
                          <h4 className="font-semibold">
                            Receita para {getPatientName(record.patientId)}
                          </h4>
                          <p className="text-sm text-muted-foreground">
                            {record.description}
                          </p>
